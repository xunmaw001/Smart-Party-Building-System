    ...
    <el-tabs tab-position="left" :style='{"border":"1px solid #9ce3b5","padding":"30px 20px","boxShadow":"0px 2px 6px #ccc,inset 0px 0px 600px 0px #e0f8e8","margin":"20px auto 0 auto","borderRadius":"4px","background":"#fff","width":"100%"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="党员账号" prop="dangyuanzhanghao">
            <el-input v-model="sessionForm.dangyuanzhanghao" placeholder="党员账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="党员姓名" prop="dangyuanxingming">
            <el-input v-model="sessionForm.dangyuanxingming" placeholder="党员姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="dangyuantouxiangHandleAvatarSuccess">
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="联系方式" prop="lianxifangshi">
            <el-input v-model="sessionForm.lianxifangshi" placeholder="联系方式" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="年龄" prop="nianling">
            <el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="学历" prop="xueli">
            <el-input v-model="sessionForm.xueli" placeholder="学历" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="身份证号" prop="shenfenzhenghao">
            <el-input v-model="sessionForm.shenfenzhenghao" placeholder="身份证号" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="入党时间">
            <el-date-picker
              v-model="sessionForm.rudangshijian"
              type="date"
              placeholder="入党时间" >
            </el-date-picker>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="支部账号" prop="zhibuzhanghao">
            <el-input v-model="sessionForm.zhibuzhanghao" placeholder="支部账号" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangyuan'" label="支部名称" prop="zhibumingcheng">
            <el-input v-model="sessionForm.zhibumingcheng" placeholder="支部名称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangzhibu'" label="支部账号" prop="zhibuzhanghao">
            <el-input v-model="sessionForm.zhibuzhanghao" placeholder="支部账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangzhibu'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangzhibu'" label="支部名称" prop="zhibumingcheng">
            <el-input v-model="sessionForm.zhibumingcheng" placeholder="支部名称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangzhibu'" label="负责人" prop="fuzeren">
            <el-input v-model="sessionForm.fuzeren" placeholder="负责人" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangzhibu'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='dangzhibu'" label="支部地址" prop="zhibudizhi">
            <el-input v-model="sessionForm.zhibudizhi" placeholder="支部地址" ></el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      if ('dangyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'dangyuanzhanghao', null);
      }
      if ('dangyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'mima', null);
      }
      if ('dangyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'dangyuanxingming', null);
      }
      if ('dangyuan' == this.userTableName) {
      ...
      if ('dangyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'rudangshijian', null);
      }
      if ('dangyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'zhibuzhanghao', null);
      }
      if ('dangyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'zhibumingcheng', null);
      }
      if ('dangzhibu' == this.userTableName) {
        this.$set(this.sessionForm, 'zhibuzhanghao', null);
      }
      if ('dangzhibu' == this.userTableName) {
        this.$set(this.sessionForm, 'mima', null);
      ...
      if ('dangzhibu' == this.userTableName) {
        this.$set(this.sessionForm, 'zhibudizhi', null);
      }

      if ('dangyuan' == this.userTableName) {
        this.$set(this.rules, 'dangyuanzhanghao', [{ required: true, message: '请输入党员账号', trigger: 'blur' }]);
      }
      if ('dangyuan' == this.userTableName) {
      ...
      if ('dangzhibu' == this.userTableName) {
        this.$set(this.rules, 'zhibuzhanghao', [{ required: true, message: '请输入支部账号', trigger: 'blur' }]);
      }
      if ('dangzhibu' == this.userTableName) {
        this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
      }
      if ('dangzhibu' == this.userTableName) {
        this.$set(this.rules, 'zhibumingcheng', [{ required: true, message: '请输入支部名称', trigger: 'blur' }]);
      }
			if ('dangzhibu' == this.userTableName) {
    ...
    methods: {
      ...
      dangyuantouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('dangyuan' == this.userTableName) {
