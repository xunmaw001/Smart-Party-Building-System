...
public class DangzhibuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DangzhibuEntity u = dangzhibuService.selectOne(new EntityWrapper<DangzhibuEntity>().eq("zhibuzhanghao", username));
		if(u==null || !u.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(u.getId(), username,"dangzhibu",  "党支部" );
    ...
    public R register(@RequestBody DangzhibuEntity dangzhibu){
    	...
    	DangzhibuEntity u = dangzhibuService.selectOne(new EntityWrapper<DangzhibuEntity>().eq("zhibuzhanghao", dangzhibu.getZhibuzhanghao()));
		if(u!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        DangzhibuEntity u = dangzhibuService.selectById(id);
